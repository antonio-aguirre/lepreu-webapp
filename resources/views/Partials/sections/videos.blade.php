    ...
    <div class="container">
        ...
        <div class="row no-gutters">          
            ...
            <div class="col-lg-6 order-lg-1 my-auto showcase-text">
                ...
                Lo invitamos a ver este breve video no explica como instalar la app, de igual manera puede ir a la sección<a class="nav-link js-scroll-trigger" href="#download">DESCARGAS</a>y oprimir el botón segun su dispositivo.</p>
            </div>
        </div>
